...
![虚拟DOM1](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%99%9A%E6%8B%9FDOM1.png)
...
![snabbdom源码中的init高阶函数](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/snabbdom%E6%BA%90%E7%A0%81%E4%B8%AD%E7%9A%84init%E9%AB%98%E9%98%B6%E5%87%BD%E6%95%B0.png)
...
![snabbdom源码中的h函数](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/snabbdom%E6%BA%90%E7%A0%81%E4%B8%AD%E7%9A%84h%E5%87%BD%E6%95%B0.png)
...
运行上面的代码，可以在浏览器中看到 <font color="#ff502c" style="background:#fff5f5">Hello Q7Long</font> .

可以查看对应生成的元素。

![snabbdom的基本使用](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/Snabbdom%E7%9A%84%E5%9F%BA%E6%9C%AC%E4%BD%BF%E7%94%A8%E9%A1%B5%E9%9D%A2%E7%BB%93%E6%9E%9C.png)

![01-basicusage.js页面内容的变化过程](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/01-basicusage.js%E9%A1%B5%E9%9D%A2%E5%86%85%E5%AE%B9%E7%9A%84%E5%8F%98%E5%8C%96%E8%BF%87%E7%A8%8B.png)

![01-basicusage.js执行过程](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/01-basicusage.js%E6%89%A7%E8%A1%8C%E8%BF%87%E7%A8%8B.png)
...
![patch()函数将新vNode替换旧vNode](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/patch()%E5%87%BD%E6%95%B0%E5%B0%86%E6%96%B0vNode%E6%9B%BF%E6%8D%A2%E6%97%A7vNode.png)
...
![使用Snabbdom创建子元素](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E4%BD%BF%E7%94%A8Snabbdom%E5%88%9B%E5%BB%BA%E5%AD%90%E5%85%83%E7%B4%A0.png)
...
![使用patch(oldVnode,h("!"))创建一个注释节点](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E4%BD%BF%E7%94%A8patch()%E5%88%9B%E5%BB%BA%E4%B8%80%E4%B8%AA%E6%B3%A8%E9%87%8A%E8%8A%82%E7%82%B9.png)
...
![03-modules的基本使用](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/03-module%E7%9A%84%E5%9F%BA%E6%9C%AC%E4%BD%BF%E7%94%A8.png)
...
![h()函数源码中的重载](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/h()%E5%87%BD%E6%95%B0%E6%BA%90%E7%A0%81%E4%B8%AD%E7%9A%84%E9%87%8D%E8%BD%BD.png)
...
![patch都做了什么](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/patch.png)
...
![调试patch函数01](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B001.png)

```js
F11进入源码内部: 可以看到传入patch的第一个参数是 id="app" 的 div  第二个参数是我们自己创建的虚拟节点Vnode
```

![调试patch函数02](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B002.png)

![调试patch函数03](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B003.png)

```js
按下F10,进行下一步，发现for循环里面，没有定义pre这个钩子函数，所以这个for循环不执行，F10进入下一步，进入isVNode方法，对oldVnode进行判断，看是不是虚拟节点Vnode，如果不是这里需要创建虚拟节点Vnode
```

![调试patch函数04](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B004.png)
...
![调试patch函数05](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B005.png)
...
![调试patch函数06](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B006.png)
...
![调试patch函数07](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B007.png)

```js
这里进入 vnode 方法，先执行的是 api.tagName(elm).toLowerCase() 之后，api.tagName(elm)拿到的就是标签的名字，这里的标签名字就是 DIV
```

![调试patch函数08](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B008.png)

```js
然后进入 vnode 方法，将真实的 DOM 转成真实的 vnode
```

![调试patch函数09](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B009.png)
...
![调试patch函数10](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B010.png)

![调试patch函数11](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B011.png)

```js
生成oldVnode(真实的vnode)之后，下一步按F11进入 sameVnode 方法，判断生成的 oldVnode 和 vnode 是否为同一节点
```

![调试patch函数12](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B012.png)
...
![调试patch函数13](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B013.png)
...
![调试patch函数14](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B014.png)

```js
vnode 对应的节点是"div#container.cls"，而oldVnode是 "#app" 对应的节点，很明显不是同一个
```

![调试patch函数15](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B015.png)

```js
如果不是同一节点，不执行 patchVnode，而是执行 else 操作，首先取到 oldVnode 的 elm 属性赋值给 elm，然后通过 api.parentNode(elm) 获取 elm即 "div#app" 的父节点
```

![调试patch函数16](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B016.png)

```js
调用api.parentNode(elm)，获取 elm 的父节点，从index.html中可以看出"div#app" 的父节点是body
```

![调试patch函数17](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B017.png)

```js
所以调用 parentNode() 方法将 body 赋值给了 parent
```

![调试patch函数18](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B018.png)

![调试patch函数19](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B019.png)

```js
执行createElm方法，将我们传入的 vnode，转换成了真实的 DOM，这里暂时不看createElm，按下F10
```

![调试patch函数20](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B020.png)

![调试patch函数21](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B021.png)

```js
这里是将 vnode = h("div#container.cls","hello world")在"div#app"之后，插入到 parent 中，parent 其实就是 body 元素，当执行完这一行，我们可以在页面中看到效果
```

![调试patch函数22](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B022.png)

![调试patch函数23](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B023.png)
...
![调试patch函数24](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B024.png)

```js
执行 removeVnodes(parent, [oldVnode], 0, 0); 将 oldVnode 从 body 中移除，并且查看Elements,可以看到效果
```

![调试patch函数25](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B025.png)

![调试patch函数26](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%B0%83%E8%AF%95patch%E5%87%BD%E6%95%B026.png)
...
![createElm流程图](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/createElm%E6%B5%81%E7%A8%8B%E5%9B%BE.png)
...
![patchVnode思维导图](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/patchVnode%E6%80%9D%E7%BB%B4%E5%AF%BC%E5%9B%BE.png)
...
![虚拟DOM例子解读](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%99%9A%E6%8B%9FDOM%E4%BE%8B%E5%AD%90%E8%A7%A3%E8%AF%BB.png)
...
![dom树](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/dom%E6%A0%91.png)
...
![节点比较](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E8%8A%82%E7%82%B9%E6%AF%94%E8%BE%83.png)
...
1. 第一种情况：新的开始节点和旧的开始节点进行比较
   ...
   ![新的开始节点和旧的开始节点](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E6%96%B0%E7%9A%84%E5%BC%80%E5%A7%8B%E8%8A%82%E7%82%B9%E5%92%8C%E6%97%A7%E7%9A%84%E5%BC%80%E5%A7%8B%E8%8A%82%E7%82%B9%E8%BF%9B%E8%A1%8C%E6%AF%94%E8%BE%83.png)
...
2. 旧的结束节点和新的结束节点进行比较
   ...
   ![旧的结束节点和新的结束节点进行比较](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E6%97%A7%E7%9A%84%E7%BB%93%E6%9D%9F%E8%8A%82%E7%82%B9%E5%92%8C%E6%96%B0%E7%9A%84%E7%BB%93%E6%9D%9F%E8%8A%82%E7%82%B9%E8%BF%9B%E8%A1%8C%E6%AF%94%E8%BE%83.png)
...
3. 旧的开始节点和新的结束节点进行比较
   ...
   ![旧的开始节点和新的结束节点进行比较](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E6%97%A7%E7%9A%84%E5%BC%80%E5%A7%8B%E8%8A%82%E7%82%B9%E5%92%8C%E6%96%B0%E7%9A%84%E7%BB%93%E6%9D%9F%E8%8A%82%E7%82%B9%E8%BF%9B%E8%A1%8C%E6%AF%94%E8%BE%83.png)
...
4. 旧的结束节点和新的开始节点进行比较
   ...
   ![旧的结束节点和新的开始节点进行比较](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E6%97%A7%E7%9A%84%E7%BB%93%E6%9D%9F%E8%8A%82%E7%82%B9%E5%92%8C%E6%96%B0%E7%9A%84%E5%BC%80%E5%A7%8B%E8%8A%82%E7%82%B9%E8%BF%9B%E8%A1%8C%E6%AF%94%E8%BE%83.png)
...
![dom比较4](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/dom%E6%AF%94%E8%BE%834.png)
...
![整体流程图](http://zql.eu5.org/images/qlBlog_images/Vue%E8%99%9A%E6%8B%9FDOM/%E6%95%B4%E4%BD%93%E6%B5%81%E7%A8%8B%E5%9B%BE.png)
